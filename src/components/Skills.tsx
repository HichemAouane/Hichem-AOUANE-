...
import { FaPython, FaDocker, FaMicrosoft, FaCode } from "react-icons/fa";
import { SiSplunk, SiC, SiGnubash, SiKalilinux, SiWireshark, SiBurpsuite, SiMetasploit, SiKubernetes, SiElastic, SiIcloud   } from "react-icons/si";
import { Shield, Users, MessageSquare, Brain, Zap } from "lucide-react";
import { TbNetwork } from "react-icons/tb";
import { MdMiscellaneousServices } from "react-icons/md";
import { FaEnvelopeCircleCheck, FaJava } from "react-icons/fa6";
...
const skills = [
    ...
    {
        category: "Networks",
        icon: <TbNetwork className="w-6 h-6" />,
        items: [
            { name: "Protocols", icon: <FaEnvelopeCircleCheck /> },
        ...
        <section id="skills" className="py-20 px-4 md:px-10 bg-black">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    Mon arsenal technique, allant des outils de sécurité offensifs et défensifs aux technologies de réseau et de scripting.
                    </p>
                </motion.div>
