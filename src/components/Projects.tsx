...
const projects = [
    {
        ...
        description: "Développement d'un Malware pour le Contrôle à Distance de la Caméra et de l'ordinateur.",
        link: "https://github.com/HichemAouane/RAT_Malware",
        color: "bg-red-500",
        image: "/RAT.png"
    }, 
    {
        title: "Malware Analysis on a keylogger",
        category: "Malware analysis",
        description: "Processus d'Analyse d'un Programme Malveillant Obtenu sur la Platforme Maleware Bazzar.",
        link: "https://github.com/HichemAouane/Malware-analysis-on-a-Keylogger",
        color: "bg-green-500",
        image: "/malanal.png"
    },
    {
        title: "Recon tool",
        category: "Outil de scan",
        description: "Outil de Reconnaissance des Caractéristiques Machine — Local & Réseau.",
        link: "https://github.com/HichemAouane/VictimPcScan",
        color: "bg-orange-500",
        image: "/recon.png"
    },

    {
        title: "Lung AI",
        category: "Model IA",
        description: "Classification des Nodules Pulmonaires via Analyse de Texture sur des Images CT-Scan.",
        link: "https://github.com/HichemAouane/LungAI",
        color: "bg-purple-500",
        image: "/lung.png"
    },
];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div>
                        ...
                        Voici quelques-uns des projets sur lesquels j'ai travaillé. Chacun représentait un défi unique qui m'a permis de progresser et d'apprendre plus.
                        </p>
                    </div>
                    <Link href="https://github.com/HichemAouane?tab=repositories" target="_blank" className="hidden md:flex items-center gap-2 text-muted-foreground hover:text-white transition-colors">
                ...
                <div className="flex justify-center">
                    <Link
                        href="https://github.com/HichemAouane"
                        target="_blank"
                    ...
                    >
                        Et bien d'autres <ArrowUpRight className="w-4 h-4" />
                    </Link>
                </div>
            </div>
        </section>
