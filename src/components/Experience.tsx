...
const experiences = [
    {
        ...
        logo: "/setirail_logo.jpg"
    },
    {
        company: "Laboratoire IA, USTHB",
    ...
    {
        company: "SETIRAIL",
        role: "Administrateur reseaux - Stage découverte",
        period: "Mars 2024",
        location: "Alger, Algérie",
        logo: "/setirail_logo.jpg"
    }
...
export default function Experience() {
    return (
        <section id="experience" className="py-20 px-4 md:px-10 bg-zinc-950">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    Mon expérience professionnelle, regroupant les stages réalisés au cours de mon parcours.
                    </p>
                </motion.div>
