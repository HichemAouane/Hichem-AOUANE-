...
const education = [
    {
        ...
        degree: "Master 1 (M1), Ingénierie des Réseaux et Systèmes (IRS)",
    ...
    },
    {
        ...
        degree: "Master 1 (M1), Sécurité des systèmes informatiques (SSI)",
            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-md">
                        Mon parcours académique et mes formations dans le domaine de  l'informatique et la cybersécurité.
                    </p>
                </motion.div>
                            ...
                            >
                                ...
                                >
                                    <div className="flex flex-col gap-4">
                                        {/* Top row: Logo + Degree/Institution */}
                                        <div className="flex items-start gap-3 md:gap-4">
                                            <div className={`w-10 h-10 md:w-12 md:h-12 rounded-full p-1 flex items-center justify-center overflow-hidden shrink-0 bg-white relative`}>
                                                <Image
                                                    src={edu.logo}
